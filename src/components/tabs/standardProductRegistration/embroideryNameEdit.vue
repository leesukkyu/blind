...
export default {
    ...
    option: {
      ...
      tagScriptCode: {
        ...
        update: function(data) {
          ...
          this.$http
            .post("/goods_api/goods_jasu_edit", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx,
              name: data.newName,
              code: data.newCode
  ...
  beforeMount: function() {
    ...
    this.option.tagScriptCode.label =
      "menu." + this.tabInfo.item.code + ".child.embroidery_name_edit";
  ...
  methods: {
    init: function() {
      console.log("init");
      this.loadEmbroideryList();
    },
    loadEmbroideryList: function() {
      this.$http
        .post("/goods_api/goods_jasu_list", {
          userid: this.$store.getters.getLoginInfo.loginInfo.id,
