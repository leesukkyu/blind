...
export default {
    ...
    option: {
      ...
      tagScriptCode: {
        ...
        onCreate: function(data) {
          ...
          this.$http
            ...
            .then(rs => {
              if (rs.status == "N") {
                this.$http
                  .post("/goods_api/goods_pattern_add", {
                    userid: this.$store.getters.getLoginInfo.loginInfo.id,
        ...
        onDelete: function(data) {
          console.log("delete...");
          this.$http
            .post("/goods_api/goods_pattern_del", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx
            })
            .then(rs => {
        ...
        update: function(data) {
          ...
          this.$http
            .post("/goods_api/goods_pattern_edit", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx,
              name: data.newName,
              code: data.newCode
  ...
  beforeMount: function() {
    ...
    this.option.tagScriptCode.label =
      "menu." + this.tabInfo.item.code + ".child.pattern_name_edit";
  ...
  methods: {
    init: function() {
      console.log("init");
      this.loadPatternNameList();
    },
    loadPatternNameList: function() {
      this.$http
        .post("/goods_api/goods_pattern_list", {
          userid: this.$store.getters.getLoginInfo.loginInfo.id,
