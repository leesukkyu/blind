...
export default {
    ...
    option: {
      ...
      tagScript: {
        ...
        onCreate: function(data) {
          this.$http
            .post("/goods_api/goods_blind_system_susun_add", {
        ...
        onDelete: function(data) {
          console.log("delete...");
          this.$http
            .post("/goods_api/goods_blind_system_susun_del", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx
            })
            .then(rs => {
        ...
        onUpdate: function(data) {
          this.$http
            .post("/goods_api/goods_blind_system_susun_edit", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx,
              name: data.newName
            })
  ...
  methods: {
    ...
    loadWidthSetting: function() {
      ...
      this.$http
        .post("/goods_api/goods_blind_system_susun_list", {
          userid: this.$store.getters.getLoginInfo.loginInfo.id,
