...
export default {
    ...
    option: {
      ...
      tagScript: {
        ...
        onCreate: function(data) {
          this.$http
            .post("/goods_api/goods_blind_system_option_add", {
        ...
        onDelete: function(data) {
          console.log("delete...");
          this.$http
            .post("/goods_api/goods_blind_system_option_del", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx
            })
            .then(rs => {
        ...
        onUpdate: function(data) {
          this.$http
            .post("/goods_api/goods_blind_system_option_edit", {
              userid: this.$store.getters.getLoginInfo.loginInfo.id,
              idx: data.item.idx,
              name: data.newName
            })
  ...
  beforeMount: function() {
    ...
    this.option.tagScript.label =
      "menu." + this.tabInfo.item.code + ".child.option_name_edit";
  ...
  methods: {
    init: function() {
      this.loadWidthSetting();
    },
    loadWidthSetting: function() {
      console.log("xx");
      this.option.tagScript.loading = true;
      this.$http
        .post("/goods_api/goods_blind_system_option_list", {
          userid: this.$store.getters.getLoginInfo.loginInfo.id,
